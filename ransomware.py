...
input_file_name = 'test.txt'  # Replace this with your input file name
output_file_name = 'test_encrypted.txt'  # Replace this with your output file name
encryption_key = 'MySecretKey'  # Replace this with your encryption key

encrypt_file(input_file_name, output_file_name, encryption_key)
